        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 1: procesos cognitivos y su relación con el aprendizaje, analiza los procesos cognitivos esenciales para el aprendizaje: memoria, atención, percepción, funciones ejecutivas y autorregulación. Se profundiza en teorías, modelos y tipos de memoria, atención y percepción, y se examinan factores que influyen en estas funciones. Además, se detalla el papel de las funciones ejecutivas en la planificación, inhibición, toma de decisiones y autorregulación. Este enfoque integral busca que los estudiantes comprendan cómo se construye el aprendizaje significativo y cómo aplicar estrategias pedagógicas desde una visión neuroeducativa.
